package com.freepan.entity.constants;
...
public class Constants {
    ...
    public static final String REDIS_KEY_DOWNLOAD = "freepan:download:";

    public static final String REDIS_KEY_SYS_SETTING = "freepan:syssetting:";

    public static final String REDIS_KEY_USER_SPACE_USE = "freepan:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "freepan:user:file:temp:";
